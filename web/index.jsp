...
<%
    ...
    if (message == null){
        ...
        msg = "<a href='book/add_book.jsp'>录入图书</a> <a href='book/del_book.jsp?clear=0'>删除图书</a> <a href=\"user/user_info.jsp?clear=0\"><img src='pic/person.png' width='25' height='24' style='margin-bottom: -5px'>"+message.getUserName()+"</a>\uD83C\uDF32<a href=\"javascript:void(0);\" onclick=\"quitLogin()\">退出</a>";
    }
%>
<html>
<head>
